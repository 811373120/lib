...
#ifndef PROTOBUF_protoctest_2eproto__INCLUDED
#define PROTOBUF_protoctest_2eproto__INCLUDED
...
class HelloWorld : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:goprotobuf.HelloWorld) */ {
 public:
  HelloWorld();
  virtual ~HelloWorld();
  ...
  // @@protoc_insertion_point(class_scope:goprotobuf.HelloWorld)
 private:
  void set_has_id();
  void clear_has_id();
  void set_has_str();
  ...
  friend struct ::protobuf_protoctest_2eproto::TableStruct;
  friend void ::protobuf_protoctest_2eproto::InitDefaultsHelloWorldImpl();
};
// ===================================================================
...
inline ::google::protobuf::int32 HelloWorld::id() const {
  // @@protoc_insertion_point(field_get:goprotobuf.HelloWorld.id)
  return id_;
}
inline void HelloWorld::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:goprotobuf.HelloWorld.id)
}
...
inline const ::std::string& HelloWorld::str() const {
  // @@protoc_insertion_point(field_get:goprotobuf.HelloWorld.str)
  return str_.GetNoArena();
}
inline void HelloWorld::set_str(const ::std::string& value) {
  set_has_str();
  str_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:goprotobuf.HelloWorld.str)
}
#if LANG_CXX11
inline void HelloWorld::set_str(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:goprotobuf.HelloWorld.str)
}
#endif
inline void HelloWorld::set_str(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:goprotobuf.HelloWorld.str)
}
inline void HelloWorld::set_str(const char* value, size_t size) {
  set_has_str();
  str_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:goprotobuf.HelloWorld.str)
}
inline ::std::string* HelloWorld::mutable_str() {
  set_has_str();
  // @@protoc_insertion_point(field_mutable:goprotobuf.HelloWorld.str)
  return str_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* HelloWorld::release_str() {
  // @@protoc_insertion_point(field_release:goprotobuf.HelloWorld.str)
  clear_has_str();
...
inline void HelloWorld::set_allocated_str(::std::string* str) {
  ...
  // @@protoc_insertion_point(field_set_allocated:goprotobuf.HelloWorld.str)
}
...
inline ::google::protobuf::int32 HelloWorld::opt() const {
  // @@protoc_insertion_point(field_get:goprotobuf.HelloWorld.opt)
  return opt_;
}
inline void HelloWorld::set_opt(::google::protobuf::int32 value) {
  set_has_opt();
  opt_ = value;
  // @@protoc_insertion_point(field_set:goprotobuf.HelloWorld.opt)
}
...
#endif  // PROTOBUF_protoctest_2eproto__INCLUDED
